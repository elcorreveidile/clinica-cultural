...
const FRASES_ESPERA = [
  ...
  'Comprobando los reflejos de tu subjuntivo… 🔨',
  'Midiendo el pulso de tu vocabulario… 💓',
  'Examinando tu comprensión auditiva… 👂',
  'Buscando síntomas de “falsos amigos”… 🕵️',
  'Auscultando tu acento… 🗣️',
  'Calibrando tu nivel del MCER… 📊',
  'Diagnosticando tus ser y estar… ⚖️',
  'Revisando la cartilla de tus conectores… 🔗',
  'Sellando tu historia clínica lingüística… 🖋️',
  'Casi listo: firmando el informe… ✍️',
];
...
const GRAMATICA: MCQ[] = [
  ...
  { q: '— ¿Qué es ___? — Es un regalo para ti.', options: ['ese', 'eso', 'esa', 'esos'], answer: 1 },
  ...
  { q: 'Para las cinco ya ___ terminado el trabajo.', options: ['He', 'Había', 'Habré', 'Haya'], answer: 2 },
  ...
  { q: 'Vámonos antes de que ___ a llover.', options: ['empieza', 'empiece', 'empezará', 'empezaba'], answer: 1 },
